#!/bin/sh
#This is combined script of all including Check.sh, default_policy.sh,selinux.sh,config_install.sh,commonhdr.sh,
#pre.sh,post.sh,preun.sh,postun.sh. "verifyscript.sh" is not necessary.
#this is used only under No X Server configurations. Thi is only for SPEC cration to specific to RHEL.
#Sumalata.Hiremath@amd.com

## version 1.0 - 1st August
## version 2.0 - 27th August
